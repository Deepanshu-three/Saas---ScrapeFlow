...
function ExecutionViewer({ initialData }: { initialData: ExecutionData }) {
  ...
  const phaseDetail = useQuery({
    queryKey: ["phaseDetail", selectedPhase, query.data?.status],
  ...
  return (
    <div className="flex w-full h-full">
      ...
      <div className="flex w-full h-full">
        ...
        {!isRunning && selectedPhase && phaseDetail.data && (
          <div className="flex flex-col py-4 container gap-4 overflow-auto">
              ...
              <Badge variant={"outline"} className="space-x-4">
                ...
                <span>
                  {DatesToDurationString(
                    phaseDetail.data.completedAt,
                    phaseDetail.data.startedAt
                  )}
                </span>
              </Badge>
            </div>
            ...
            <ParameterViewer
              ...
              paramsJson={phaseDetail.data.inputs}
            />

            <ParameterViewer
              title="Outputs"
              subTitle="Outputs generated by this phase"
              paramsJson={phaseDetail.data.outputs}
            />

            <LogViewer logs={phaseDetail.data.logs} />
          </div>
        )}
      </div>
    </div>
